...
global.ips = JSON.parse(fs.readFileSync(path.join(__dirname, "../data/ips.male.json")));
...
test("should handle male patient (not childbearing)", async () => {
  ...
  expect(explanation.status.childbearingAge).toBe(false);
